                        ...
                        <div class="col-xl-3">
                            <div class="input-group w-100 mx-auto d-flex">
                                <form id="searchForm" style="display: flex">
                                    <input type="search" name="keyword" class="form-control p-3" placeholder="keywords" aria-describedby="search-icon-1" value="${param.keyword}">
                            ...
                            <div class="col-12">
                                <div class="pagination d-flex justify-content-center mt-5">
                                    ...
                                    <% for (int i = 1; i <= (Integer) request.getAttribute("totalPages"); i++) {
                                            String pageClass = request.getAttribute("currentPage").equals(i) ? "active rounded" : "rounded";
                                    %>
                                    <a href="shop?page=<%=i%>" class="<%=pageClass%>"><%=i%></a>
                                    <% }%>
                                    <a href="shop?page=<%=request.getAttribute("totalPages")%>" class="rounded">&raquo;</a>
                                </div>
                            </div>
